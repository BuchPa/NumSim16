function [ vel_u, vel_v, pres ] = read_vts( filename, nCells, verbose )
...
% Reshape arrays
vel_u = reshape(vel(:,1),nCells(1),nCells(2))';
vel_v = reshape(vel(:,2),nCells(1),nCells(2))';

pres  = reshape(pres,nCells(1),nCells(2))';
end